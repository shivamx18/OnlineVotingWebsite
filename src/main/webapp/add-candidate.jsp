    ...
    <div class="container mt-5">
        ...
        <form action="CandidateServlet?action=add" method="post">
           <div class="mb-3">
                ...
                <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Enter Candidate first name">
            </div>
            <div class="mb-3">
                <label for="last_name" class="form-label"><i class="fas fa-user"></i> Last Name</label>
                <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Enter Candidate last name">
            </div>
        
            <div class="mb-3">
                <label for="email" class="form-label"><i class="fas fa-envelope"></i> Email</label>
                <input type="email" class="form-control" id="email" name="email" placeholder="Enter Candidate email">
            </div>
