...
<%
    ...
    if (session.getAttribute("userRole") == null || !session.getAttribute("userRole").equals("voter")) {
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="VoterServlet?action=update" method="post" class="mt-4">
            ...
            <a href="VoterServlet?action=view&voter_id=${voter.voterId}" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
