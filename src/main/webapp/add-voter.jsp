    ...
    <div class="container mt-5">
        ...
        <form action="VoterServlet?action=add" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="username_signup" name="username" placeholder="Choose a username">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="password_signup" name="password" placeholder="Create a password">
            </div>
